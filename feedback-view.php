    ...
    <body>
        ...
        <section id='content-image'>
            <div class='row'>
                ...
                <p><?php echo str_replace($newline,$replace,$row['Feedback']) ; ?> </p>
                <h3>Response from Admin: </h3>
                 <p><?php echo $has_response?str_replace($newline,$replace,$row['Response']):($is_admin?"":"The admin has not responded yet"); ?></p>
