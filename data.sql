...
(1, 'kimo', 'k@g.com', 'k1', 'BMW L0 missing', 'The BMW L0 that was recently released is missing from this website despite news of it coming here soon', 'While we plan on selling the L0 soon, it hasn&#39;t arrived yet to our branches and this website only lists currently available cars'),
(2, 'kimo', 'k@g.com', 'k1', 'Tesla roadster price', 'The Tesla Roadster is listed here at a higher price than elsewhere since I can see it listed at $160000 at other dealerships', 'Cars listed here have the latest prices available, including tax which is a 20% here'),
(3, 'kimo', 'k@g.com', 'k1', 'BMW X6 has inaccurate information', 'The BMW X6 lists 35bhp but that doesn&#39;t seem to be correct since testing shows that it never surpasses 23bhp, so please make sure to correct it quickly', NULL),
(4, 'ziad ehab', 'ziad@gmail.com', 'zizozidan1', 'Car Broke down', 'I&#39;m very disappointed in this dealership as I got sold an Audi A4 that stopped working in the first week, I want a complete refund now', NULL);
